...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const nameInput = contactForm.querySelector('[name="name"], #name, input[type="text"]:not([name="email"]):not([name="phone"])');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '689cd30c-0dee-4a2e-8e25-c46f7738f2a2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '689cd30c-0dee-4a2e-8e25-c46f7738f2a2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '689cd30c-0dee-4a2e-8e25-c46f7738f2a2';
